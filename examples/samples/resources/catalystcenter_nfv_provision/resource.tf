...
resource "catalystcenter_nfv_provision" "example" {
  provider = catalystcenter
  parameters {
    provisioning {
...
output "catalystcenter_nfv_provision_example" {
  value = catalystcenter_nfv_provision.example
}

data "catalystcenter_dnacaap_management_execution_status" "example" {
  depends_on   = [catalystcenter_nfv_provision.example]
  provider     = catalystcenter
  execution_id = catalystcenter_nfv_provision.example.item.0.execution_id
}
