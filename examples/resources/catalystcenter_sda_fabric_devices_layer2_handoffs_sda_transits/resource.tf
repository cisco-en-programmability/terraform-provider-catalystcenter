...
resource "catalystcenter_sda_fabric_devices_layer2_handoffs_sda_transits" "example" {
...
output "catalystcenter_sda_fabric_devices_layer2_handoffs_sda_transits_example" {
  value = catalystcenter_sda_fabric_devices_layer2_handoffs_sda_transits.example
}