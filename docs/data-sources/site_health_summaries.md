...
description: |-
  ...
  specs/blob/main/Assurance/CECatCenter_Org-siteHealthSummaries-1.0.3-resolved.yamlGet a health summary for a specific site by providing the unique site id in the url path. This data source provides
