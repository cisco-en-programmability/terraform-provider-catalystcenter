...
page_title: "catalystcenter_network_devices_top_n_analytics Resource - terraform-provider-catalystcenter"
subcategory: ""
description: |-
  ...
  specs/blob/main/Assurance/CECatCenter_Org-AssuranceNetworkDevices-2.0.1-resolved.yaml
  The required properties for this API are topN and groupBy
---

# catalystcenter_network_devices_top_n_analytics (Resource)
