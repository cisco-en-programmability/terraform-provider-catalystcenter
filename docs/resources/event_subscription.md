...
page_title: "catalystcenter_event_subscription Resource - terraform-provider-catalystcenter"
subcategory: ""
description: |-
...
```shell
terraform import catalystcenter_event_subscription.example "id:=string"
```
